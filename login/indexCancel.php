...
<head>
	<title>SEMIRA | SMA Islam An-Nizhomiyah</title>
...
<body id="home" class="content danger">
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse" id="zero-menu" aria-expanded="true">
				<ul class="nav navbar-right">
					...
					<li>
						<a href="#kandidat" rel="page-scroll" title="Kandidat Ketua BKM">Kandidat</a>
					</li>
					<li>
						<a href="#galeri" rel="page-scroll" title="Galeri Kegiatan BKM">Galeri</a>
					</li>
					<li>
						<a href="#BKM" rel="page-scroll" title="Personil BKM Sekarang">BKM</a>
					</li>
					<li>
	...
	<div class="row content" id="kandidat">
		<div class="col-md-12 danger text-center zero-panel">
			<div class="col-md-8 zero-panel-content">
				<h1 id="title-about"> KANDIDAT BKM </h1>
				<?php
	...
	<div class="row content" id="galeri">
		<div class="col-md-12 primary text-center zero-panel">
			<div class="col-md-8 zero-panel-content">
				<h1> GALERI KEGIATAN BKM </h1>
				<p>
					Inilah beberapa kegiatan BKM yang terdokumentasikan. Silahkan klik untuk tampilan secara rinci.
				</p>
			</div>
	...
	<div class="row content" id="BKM">
		<div class="col-md-12 primary zero-panel text-center">
			<div class="col-md-12 zero-panel-content">
				...
				<div class="col-md-8 zero-panel-content">
					<div class="quote">
						Silahkan sampaikan masukan anda untuk perbaikan program SEMIRA kedepannya
					</div>

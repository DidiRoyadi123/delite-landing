...
if(isset($_POST['simpan'])){
	...
	if(empty($lokasi)){
		$sql="INSERT INTO proyek SET nip='$nip', username='$pengguna', password='$sandi', nama='$nama', mengajar='$mengajar',hp='$hp',email='$surel', aktif='$aktif'";
	}else{
		...
		$sql="INSERT INTO proyek SET nip='$nip', username='$pengguna', password='$sandi', nama='$nama', mengajar='$mengajar',hp='$hp',email='$surel', aktif='$aktif', foto='$namafile'";
	}

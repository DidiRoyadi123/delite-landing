  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="?m=proyek"><i class="fa fa-user"></i> proyek</a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
			 <!--Mulai buat form-->
			 <form action="?m=proyek&s=simpan" method="post" enctype="multipart/form-data">
              <table id="SEMIRA1" class="table table-bordered table-hover table-striped">
                <tbody>
					<tr>
						<td width=174>Nama Pengguna</td>
						<td><input type="text" name="username" placeholder="Username" size="50px" maxlength="25px" /><small>Kosongkan untuk username=No Induk proyek</small></td>
					</tr>
					<tr>
						<td>Sandi</td>
						<td><input type="password" name="password" placeholder="Password" size="50px" maxlength="32px"/><small>Kosongkan untuk Password=Nama Lengkap proyek</small></td>
					</tr>
					<tr>

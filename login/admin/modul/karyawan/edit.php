								...
								<tbody>
									...
									<tr>
										...
										<td><input type="radio" name="jk" id="jkl" value="L" <?php if ($r['jk'] == 'L') echo " checked"; ?> />Laki-laki &nbsp;&nbsp;
											<input type="radio" name="jk" id="jkp" value="P" <?php if ($r['jk'] == 'P') echo " checked"; ?> />Perempuan
										</td>
									</tr>
									<tr>
										<td>Tempat Lahir</td>
									...
									<tr>
										...
										<td>
											<select name="divisi">
												<?php
												$sql2 = "SELECT * FROM divisi ORDER BY divisi";
												$query2 = mysqli_query($koneksi, $sql2);
												while ($r2 = mysqli_fetch_assoc($query2)) {
													echo "<option value='" . $r2['iddivisi'] . "'";
													echo $r2['iddivisi'] == $r['iddivisi'] ? "selected" : "";
													echo ">" . $r2['divisi'] . "</option>";
												}
												?>
											</select>
										</td>
									...
									<tr>
										...
										<td><input type="radio" name="aktif" id="aktifY" value="Y" <?php if ($r['aktif'] == 'Y') echo " checked"; ?> />Ya &nbsp;&nbsp;
											<input type="radio" name="aktif" id="aktifT" value="T" <?php if ($r['aktif'] == 'T') echo " checked"; ?> />Tidak
										</td>
									</tr>
									<tr>
										<td>Foto</td>
										<td>
											<?php
											if ($r['foto'] != '') {
												echo "<img src=\"../gambar/karyawan/$r[foto]\" height=150 />";
											} else {
												echo "<img src=\"../gambar/karyawan/0.jpg\"height=150 >";
											}
											?>
									</tr>
									<tr>
									...
									<tr>
										<td colspan=3>
											...
											<a href="?m=karyawan" class="btn btn-large btn-danger"><i class="fa fa-times"></i> List</a>
										</td>
									</tr>
								</tbody>
							</table>

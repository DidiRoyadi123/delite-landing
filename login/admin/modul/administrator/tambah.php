                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <form action="?m=admin&s=simpan" method="post" enctype="multipart/form-data">
                            <table id="Delite1" class="table table-bordered table-hover table-striped">
                                <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Aktifkan</td>
                                        <td>
                                            <input type="radio" name="aktif" id="aktifY" value="Y" />Ya &nbsp;&nbsp;
                                            <input type="radio" name="aktif" id="aktifT" value="T" checked />Tidak
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Foto</td>
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            ...
                                            <a href="?m=admin" class="btn btn-large btn-danger"><i class="fa fa-times"></i> List</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>

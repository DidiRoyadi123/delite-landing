        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Form Tambah divisi</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
			 <!--Mulai buat form-->
			 <form action="?m=divisi&s=simpan" method="post" enctype="multipart/form-data">
              <table id="SEMIRA1" class="table table-bordered table-hover table-striped">
                <tbody>
					<tr>
						<td width=174>Nama divisi*</td>
						<td><input type="text" name="divisi" placeholder="divisi" size="7px" maxlength="7px" required /></td>
					</tr>
					<tr>

    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="." class="logo">
          ...
          <span class="logo-lg"><b>karyawan </b>SEMIRA</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="../gambar/karyawan/<?php echo $_SESSION['fotoskasis']; ?>" class="user-image" alt="<?php echo $_SESSION['userskasis']; ?>">
                  <span class="hidden-xs"><?php echo $_SESSION['namaskasis']; ?></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="../gambar/karyawan/<?php echo $_SESSION['fotoskasis']; ?>" class="img-circle" alt="<?php echo $_SESSION['userskasis']; ?>">
                    <p>
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="?m=karyawan&s=profil" class="btn btn-default btn-flat">Profile</a>
                    </div>
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            ...
            <div class="pull-left info">
              ...
              <a href="?m=karyawan&s=profil"><i class="fa fa-circle text-success"></i> Online</a>
            </div>
          </div>
          <!-- search form -->
